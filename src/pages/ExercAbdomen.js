...
import Abdominal from "../Componente/Abdominal";
import Loading from "../Componente/Loading/Loading";

export default function Abdomen({ navigation }) {
    ...
    useEffect(() => {
        fetch('https://fitapp-tcc.azurewebsites.net/api/ABSIniciante', {
            method: 'GET'
        })
        ...
        <ScrollView style={{ width: '100%', height: 1000, }}>
            <View style={styles.container}>
                ...
                <View style={{ width: '100%', alignItems: 'center' }}>
                    {
                        exercicio.map((abdomen, index) => (
                            <Abdominal abdomen={abdomen} key={index} />
                        ))
                    }
                </View>
