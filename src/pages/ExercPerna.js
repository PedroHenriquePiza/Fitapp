...
import PernaIni from "../Componente/Perna";
import Loading from "../Componente/Loading/Loading";

export default function Perna({ navigation }) {
    ...
    useEffect(() => {
        fetch('https://fitapp-tcc.azurewebsites.net/api/pniniciante', {
            method: 'GET'
        })
            ...
            <View>
                ...
                <View style={styles.logo}>
                 ...
                 <View style={{ width: '100%', alignItems: 'center'}}>
                    {
                        exercicio.map((perna, index) => (
                            <PernaIni perna={perna} key={index}/>
                        ))
                    }
                </View>
                <View>
                    <TouchableOpacity style={styles.buttonComecar} onPress={() => navigation.navigate("ExecucaoPernaIniciante")}>
                        <Text> COMEÇAR </Text>
                    </TouchableOpacity>
                </View>
            </View>
