...
import PeitBracAvan from "../Componente/PeitBracAvan";
import Loading from "../Componente/Loading/Loading";

export default function PeitoBracoAvan({ navigation }) {
        ...
        <ScrollView style={{ width: '100%', height: 1200 }}>
            ...
            <View>
                ...
                <View style={{ width: '100%', alignItems: 'center'}}>
                    {
                        exercicio.map((peitbracavan, index) => (
                            <PeitBracAvan peitbracavan={peitbracavan} key={index}/>
                        ))
                    }
                </View>
               
                <View>
                    <TouchableOpacity style={styles.buttonComecar} onPress={() => navigation.navigate("ExecucaoPTBRAvan")}>
                        <Text> COMEÇAR </Text>
                    </TouchableOpacity>
                </View>
            </View>
