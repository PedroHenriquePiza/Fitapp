...
import AbdominalAvan from "../Componente/AbdomenAvan";
import Loading from "../Componente/Loading/Loading";

export default function AbdomenAvan ({ navigation }) {
    ...
    useEffect(() => {
        fetch('https://fitapp-tcc.azurewebsites.net/api/ABSAvancado', {
            method: 'GET'
        })
        ...
        <ScrollView style={{ width: '100%', height: 1200 }}>
            ...
            <View>
                ...
                <View style={{ width: '100%', alignItems: 'center'}}>
                    {
                        exercicio.map((abdominalavan, index) => (
                            <AbdominalAvan abdominalavan={abdominalavan} key={index}/>
                            ))
                    }
                </View>
               
                <View>
                    <TouchableOpacity style={styles.buttonComecar} onPress={() => navigation.navigate("Execucao")} >
                        <Text> COMEÇAR </Text>
                    </TouchableOpacity>
                </View>
            </View>
