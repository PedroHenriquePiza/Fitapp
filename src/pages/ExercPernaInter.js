...
import PernaInter from "../Componente/PernaInter";
import Loading from "../Componente/Loading/Loading";

export default function PernaIntermediario ({ navigation }) {
            ...
            <View>
                ...
                <View style={styles.logo}>
                 ...
                 <View style={{ width: '100%', alignItems: 'center'}}>
                    {
                        exercicio.map((pernainter, index) => (
                            <PernaInter pernainter={pernainter} key={index}/>
                        ))
                    }
                </View>
                <View>
                    <TouchableOpacity style={styles.buttonComecar} onPress={() => navigation.navigate("ExecucaoPernaInter")}>
                        <Text> COMEÇAR </Text>
                    </TouchableOpacity>
                </View>
            </View>
