...
import OmbrCost from "../Componente/OmbroCostas";
import Loading from "../Componente/Loading/Loading";

export default function OmbroCostas({ navigation }) {
    ...
    useEffect(() => {
        fetch('https://fitapp-tcc.azurewebsites.net/api/ctobiniciante', {
            method: 'GET'
        })
        ...
        <ScrollView style={{ width: '100%', height: 1000 }}>
            ...
            <View>
                ...
                <View style={{ width: '100%', alignItems: 'center'}}>
                    {
                        exercicio.map((ombrocostas, index) => (
                              <OmbrCost ombrocostas={ombrocostas} key={index}/>       
                            ))
                    }
                </View>
               
                <View>
                    <TouchableOpacity style={styles.buttonComecar} onPress={() => navigation.navigate("ExecucaoOmbroCostas")}>
                        <Text> COMEÇAR </Text>
                    </TouchableOpacity>
                </View>
            </View>
