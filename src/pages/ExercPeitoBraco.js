...
import PeitBrac from "../Componente/PeitBrac";
...
export default function PeitoBraco({ navigation }) {
    ...
    useEffect(() => {
        fetch('https://fitapp-tcc.azurewebsites.net/api/ptbriniciante', {
            method: 'GET'
        })
        ...
        <ScrollView style={{ width: '100%', height: 1200 }}>
            ...
            <View>
                ...
                <View style={{ width: '100%', alignItems: 'center'}}>
                    {
                        exercicio.map((peitbrac, index) => (
                            <PeitBrac peitbrac={peitbrac} key={index}/>
                        ))
                    }
                </View>
               
                <View>
                    <TouchableOpacity style={styles.buttonComecar} onPress={() => navigation.navigate("ExecucaoPTBR")}>
                        <Text> COMEÇAR </Text>
                    </TouchableOpacity>
                </View>
            </View>
