...
import OmbroCostasExecItem from "../Componente2/OmbroCostasExecItem";
import OmbrCost from './../Componente/OmbroCostas';

export default function OmbroCostasExec({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      {exercicio[indiceExercicio] && (
        <OmbroCostasExecItem CTOB={exercicio[indiceExercicio]} />
      )}
